...
public java.util.Map<String, Object> getOnafterTextChangeEventObj(Editable s) {
	...
	private void nativeCreate(Map<String, Object> params) {
		...
		ViewImpl.setOnListener(imageButton, org.eclipse.swt.SWT.MouseDown, org.eclipse.swt.SWT.MouseDown + "", (event) -> {
			showTimePicker();
		});
	...
	public void showTimePicker() {
		...
		final org.eclipse.swt.widgets.DateTime calendar = new org.eclipse.swt.widgets.DateTime (dialog, org.eclipse.swt.SWT.TIME | org.eclipse.swt.SWT.BORDER);
		org.eclipse.swt.widgets.Button ok = new org.eclipse.swt.widgets.Button (dialog, org.eclipse.swt.SWT.PUSH);
		ok.setText ("OK");
		ok.setLayoutData(new org.eclipse.swt.layout.GridData (org.eclipse.swt.SWT.FILL, org.eclipse.swt.SWT.CENTER, false, false));
	
		ok.addSelectionListener (new org.eclipse.swt.events.SelectionAdapter () {
			public void widgetSelected (org.eclipse.swt.events.SelectionEvent e) {
				setTime(calendar.getHours(), calendar.getMinutes());
				dialog.close ();
			}
		});
		dialog.pack();
	...
	private void setOnClickListener(IWidget clearButton, OnClickListener onClickListener) {
		ViewImpl.setOnListener(clearButton, org.eclipse.swt.SWT.MouseDown, org.eclipse.swt.SWT.MouseDown + "", (event) -> {
